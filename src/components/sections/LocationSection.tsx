...
export function LocationSection() {
  return (
    <section className="bg-champagne/40 py-20 lg:py-32 px-5 sm:px-8 lg:px-20 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      <div>
        <span className="eyebrow text-gold text-[10px] lg:text-[11px]">{LOCATION_SECTION.eyebrow}</span>
        <h2 className="font-display text-[2rem] sm:text-4xl lg:text-5xl mt-4 lg:mt-6 leading-tight">
          {LOCATION_SECTION.heading} <br />{LOCATION_SECTION.headingLine2}
        </h2>
        ...
        <a href="#" className="inline-block mt-7 lg:mt-8 eyebrow text-brown border-b border-gold pb-2">
